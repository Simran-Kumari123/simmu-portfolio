...
export const skills: Skill[] = [
  ...
  { name: 'Spring Boot', icon: 'SiSpring', category: 'backend', proficiency: 3 },
  { name: 'ASP.NET Core', icon: 'SiDotnet', category: 'backend', proficiency: 3 },
  ...
  { name: 'SQLite', icon: 'SiSqlite', category: 'database', proficiency: 3 },
  { name: 'Oracle', icon: 'SiOracle', category: 'database', proficiency: 3 },
  ...
  { name: 'Netlify', icon: 'SiNetlify', category: 'tools', proficiency: 4 },

  // Other
  { name: 'GraphQL', icon: 'SiGraphql', category: 'other', proficiency: 3 },
  { name: 'Socket.io', icon: 'SiSocketdotio', category: 'other', proficiency: 3 },
  { name: 'Redux', icon: 'SiRedux', category: 'other', proficiency: 3 },
  { name: 'Postman', icon: 'SiPostman', category: 'other', proficiency: 3 },
];
